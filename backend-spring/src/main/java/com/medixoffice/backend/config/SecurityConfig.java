package com.medixoffice.backend.config;

import com.medixoffice.backend.security.JwtAccessDeniedHandler;
import com.medixoffice.backend.security.JwtAuthenticationEntryPoint;
import com.medixoffice.backend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            throw new UsernameNotFoundException("Authentication is JWT-only; UserDetailsService is not used");
        };
    }
